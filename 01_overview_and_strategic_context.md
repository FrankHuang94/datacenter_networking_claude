...
- **Ultra Ethernet Consortium (UEC)**, founded in 2023 under the Linux Foundation, owns the modernized Ethernet stack for AI and HPC — the Ultra Ethernet Transport (UET), its congestion control, and its in-network collective capabilities. **Specification 1.0 was published in June 2025** (a ~560-page document spanning NICs, switches, optics, and cables), with a 1.0.2 revision in 2026. It is the open ecosystem's principal answer to InfiniBand and to NVIDIA's Spectrum-X (Files 06, 24).

- **UALink Consortium** owns the open **scale-up** accelerator interconnect. The **UALink 200G 1.0 specification** was published in April 2025: 200 Gbps per lane, scaling to 1,024 accelerators in a pod (Files 15, 24).

- **OCP ESUN (Ethernet for Scale-Up Networking)** is the workstream, launched in 2025, applying Ethernet to the pod-internal scale-up domain, coordinating explicitly with IEEE 802.3 and the UEC. Its founding participant list — including AMD, Arista, Arm, Broadcom, Cisco, HPE, Marvell, Meta, Microsoft, NVIDIA, OpenAI, and Oracle — is itself notable for including the incumbent it is designed to compete with.

Read together, these three bodies represent something new: the open-standards response to a dominant vertically integrated supplier is no longer a single effort but a coordinated three-front campaign covering scale-out (UEC), scale-up (UALink, ESUN), and the memory fabric (CXL). All three published their foundational specifications during 2025; whether the silicon and the multi-vendor ecosystems follow is the story of 2026–2028.
...
- The **optical transceiver market** reached roughly **$24 billion in 2025** — having grown about 60% in that year alone, from a base around $15 billion — and is forecast to grow at a similar rate again in 2026 toward the mid-$20-billions and beyond. It is among the fastest-growing hardware categories in technology, propelled by the transition from 100G to 400G to 800G to 1.6T and the explosive demand for AI cluster interconnect. A single large AI training cluster can consume hundreds of thousands of high-speed optical transceivers. The binding constraint is now upstream: **InP EML and laser chip supply** has been running roughly 30% short of demand (File 21).
...
The economics of AI have warped these markets. In a traditional cloud datacenter, networking might represent 10–15% of capital expenditure. In an AI training cluster, the networking fraction can be substantially higher when measured properly, because each GPU server demands an order of magnitude more network bandwidth, and because the InfiniBand or high-end Ethernet fabric required to deliver lossless, low-latency, high-bandwidth interconnect commands premium pricing. NVIDIA's networking revenue alone reached roughly **$31 billion in its fiscal 2026** — larger, by itself, than the entire datacenter networking equipment market was a few years earlier — and the company has explicitly positioned the network, not just the GPU, as a strategic control point. Whatever else this database argues, that single figure is the most compact evidence for its central premise: networking stopped being plumbing.
...
- **Switch and router systems**: Cisco (the traditional incumbent, dominant in enterprise and carrier, present in cloud), Arista (the cloud-and-AI-optimized challenger, revenue $9.0B in FY2025 after growing 28.6%), Juniper (strong in service-provider routing; **its acquisition by HPE closed in July 2025**, and it now anchors HPE Networking), and the white-box ecosystem (Dell, Edgecore, and others running SONiC or other disaggregated NOSes on merchant silicon). By revenue, **NVIDIA has taken the lead in datacenter Ethernet switching** on the strength of Spectrum-X — a striking inversion, given that it does not sell into the traditional enterprise market at all (File 23).
...
- **AI fabric**: NVIDIA dominant via InfiniBand (a near-monopoly), NVLink/NVSwitch (proprietary scale-up), and Spectrum-X (its Ethernet AI play), challenged by AMD (Ethernet-centric, plus UALink and the Helios rack), Intel (Gaudi, Ethernet-centric), and the hyperscalers' custom interconnects (Google TPU ICI, Amazon NeuronLink). The state of play as of 2026 is worth stating precisely because it is easy to misread: **Ethernet passed InfiniBand** in AI back-end networks during 2025 and reached roughly two-thirds of AI-cluster switch revenue — but much of that Ethernet is NVIDIA's own. The protocol changed; the concentration did not.

- **Optical systems and components**: Ciena and Nokia (which **absorbed Infinera in February 2025**) in DWDM and DCI systems, with Huawei strong outside Western markets; Lumentum and Coherent (the merged II-VI/Coherent) in components (WSS, lasers, modulators); Acacia (Cisco), Marvell (Inphi), and others in coherent DSPs; and a large transceiver-module ecosystem spanning Western (Coherent, Lumentum) and Chinese (InnoLight, Eoptolink, Accelink, HiLink) suppliers.
